<?php
	...
	if($cpass!=$repass){
		?>
		<script>
			window.alert('Required passwords did not match. Account Tidak di update!');
			window.history.back();
		</script>
		<?php
	}
	elseif($cpass!=$srow['password']){
		?>
		<script>
			window.alert('Current password did not match. Account Tidak di update!');
			window.history.back();
		</script>
		<?php
	}
		...
		?>
		<script>
			window.alert('Account Berhasil di update!');
			window.history.back();
		</script>
		<?php
	}
