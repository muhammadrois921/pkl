        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					...
					?>
                    <h5><center>Nama Customer: <strong><?php echo ucwords($b['customer_name']); ?></strong></center></h5>
            ...
            <div class="modal-content">
				...
				<div class="container-fluid">
                    ...
                    <form role="form" method="POST" action="edit_customer.php<?php echo '?id='.$cqrow['userid']; ?>">
						...
						<div style="height:10px;"></div>
						<div class="form-group input-group">
                            <span class="input-group-addon" style="width:120px;">Alamat:</span>
						...
						<div style="height:10px;"></div>
						<div class="form-group input-group">
                            <span class="input-group-addon" style="width:120px;">No Telp:</span>
