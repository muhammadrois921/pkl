            ...
            <div class="modal-content">
				...
				<div class="container-fluid">
                    <form role="form" method="POST" action="save_profile.php<?php echo '?id='.$_SESSION['id']; ?>" enctype="multipart/form-data">
						...
						<div class="form-group input-group">
                            <span style="width:150px;" class="input-group-addon">Nama:</span>
						...
						<div class="form-group input-group">
                            <span style="width:150px;" class="input-group-addon">Alamat:</span>
						...
						<div class="form-group input-group">
                            <span style="width:150px;" class="input-group-addon">No Telp:</span>
