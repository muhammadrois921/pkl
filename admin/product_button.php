        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">Hapus Produk</h4></center>
                </div>
				...
				<div class="container-fluid">
					...
					?>
                    <h5><center>Nama Produk: <strong><?php echo $b['product_name']; ?></strong></center></h5>
				...
				<div class="container-fluid">
                    ...
                    <form role="form" method="POST" action="edit_product.php<?php echo '?id='.$pid; ?>" enctype="multipart/form-data">
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:120px;">Nama Produk:</span>
