				...
				<div>
					...
					<div style="margin-left:17px; margin-right:17px;">
						<button type="button" class="btn btn-primary btn-sm addcart" value="<?php echo $row['productid']; ?>"><i class="fa fa-shopping-cart fa-fw"></i> Cart</button> 
					        <a href="#d<?php echo $row['productid']; ?>" style="margin-left: 10px;" data-toggle="modal" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-fullscreen"></span> Details</a>
                                                <?php //include('d.php'); ?>
                                        </div>
				</div>
				</div>
